...
{
    [Option('c', "cloud", HelpText = "Please specify the cloud with -c. See docs on getting started here: {doc-link}", Default = Constants.Azure)]
    ...
    [Option('e', "enviornment", HelpText = "Please specify the name to prefix the infrastructure with -e. Please see doc {insert doc link}", Default = Constants.Dev)]
