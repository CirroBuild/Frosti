using System;
namespace Frosti.Linkers;

	public class AzureDotnetLinker
	{
    public static async Task Link(string env, Dictionary<string, string> configs, HashSet<string> services)
    {
